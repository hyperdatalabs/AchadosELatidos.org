  ...
  return (
    <div>
      <Layout>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box>
              ...
              <Box sx={{ display: "flex", gap: "1rem", my: 2 }}>
                ...
                <Typography sx={{ alignContent: "center", flex: 1 }}>
                  <Link href="/submit">
                    Preencha o formulário disponível em &quot;CADASTRAR
                    PET&quot; com informações detalhadas sobre seu animal
                    perdido, incluindo fotos recentes e localização onde foi
              ...
              <Link href="#cta">
                <Button fullWidth sx={{ my: 2 }} variant="contained">
                  QUERO COLABORAR
                </Button>
              </Link>
            </Box>
        ...
        <Grid container>
          <Grid item xs={12} sx={{ alignContent: "center", my: 2 }} md={6}>
            <Typography
              variant="h2"
              sx={{ textAlign: "center" }}
              md={{ textAlign: "left" }}
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/p/C7UGUsuuiZY/?utm_source=ig_embed&utm_campaign=loading"
              ...
              >
                <div style={{ padding: 16 }}>
                  {" "}
                  <a
                    href="https://www.instagram.com/p/C7UGUsuuiZY/?utm_source=ig_embed&utm_campaign=loading"
                    style={{
                      background: "#FFFFFF",
                      lineHeight: 0,
                      padding: "0 0",
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                    >
                      Uma publicação compartilhada por @achadoselatidos
                    </a>
                  </p>
                </div>
              </blockquote>
